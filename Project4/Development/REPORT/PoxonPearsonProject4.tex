...
where a transtition to a lower energy state is always accepted, but a transition to a higher energy state is accepted with some probability depending on the energy difference.  This is the algorithm we will us in our calculation.
